...
5. Verify if the deployment operation is executed as expected as specified in `ota_deploy.sh`. And in this example, it should generate an _allxonOTA.args_ file with_ Hello World_ string inside.
